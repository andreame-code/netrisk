export const en = Object.freeze({
  ...
  "auth.status.loggedIn": "Logged in as {username}.",
  ...
  "login.title": "Frontline Dominion - Log in",
  "login.eyebrow": "Login",
  "login.heading": "Log in to command",
  "login.copy": "Log in and return directly to the requested page.",
  ...
  "lobby.loginToOpen": "Log in to open",
  "lobby.loginToJoin": "Log in to join",
  ...
  "lobby.loadMore.partial": "Showing {visible} of {total} games.",
  "lobby.loadMore.complete": "All {total} games are visible.",
  "lobby.loadMore.action": "Load more",
  ...
  "warTable.lobby.loginToJoin": "Log in to join",
  "warTable.lobby.loginToView": "Log in to view",
  ...
  "newGame.slot.difficultyLabel": "AI difficulty",
  "newGame.slot.difficultyEasy": "Easy",
  "newGame.slot.difficultyMedium": "Medium",
  "newGame.slot.difficultyHard": "Hard",
  ...
  "newGame.invalidAiDifficulty": "Selected AI difficulty is not supported.",
  ...
  "game.command.available": "Available",
  "game.command.owner": "Owner",
  "game.command.toMove": "To move",
  "game.commandMode.attack": "Attack",
  "game.commandMode.commands": "Commands",
  "game.commandMode.fortify": "Fortify",
  "game.commandMode.moveConquestArmies": "Move conquest armies",
  ...
  "game.commandDock.selectedTerritory": "Selected territory",
  "game.commandDock.from": "From",
  "game.commandDock.to": "To",
  "game.commandDock.dice": "Dice",
  "game.commandDock.addAll": "Add all ({count})",
  "game.commandDock.addAllAria": "Add every reinforcement ({count})",
  "game.commandDock.armiesToMove": "Armies to move",
  "game.commandDock.yourCards": "Your Cards",
  "game.commandDock.mustTradeToContinue":
    "You must trade in cards to receive reinforcements and continue your turn.",
  "game.commandDock.selectCardsToTrade": "Select 3 cards to trade",
  "game.commandDock.cardsSelected": "{selected} / 3 selected",
  "game.commandDock.chooseThreeCards": "Choose three cards from your hand.",
  "game.commandDock.clearSelection": "Clear selection",
  "game.commandDock.tradeCards": "Trade Cards",
  "game.commandDock.exchangeBonus": "Exchange bonus",
  "game.commandDock.cardsSet": "{count} cards set",
  "game.commandDock.applying": "Applying...",
  "game.commandDock.attacking": "Attacking...",
  "game.commandDock.moving": "Moving...",
  "game.commandDock.fortifying": "Fortifying...",
  "game.commandDock.trading": "Trading...",
  "game.commandDock.updating": "Updating...",
  "game.activityFilter.all": "All",
  "game.activityFilter.combat": "Combat",
  "game.activityFilter.cards": "Cards",
  "game.activityFilter.turn": "Turn",
  "game.activityFilter.aria": "Activity log filters",
  "game.activityFilter.clearLog": "Clear log",
  ...
  "game.hud.reinforcements": "Reinforcements",
  ...
  "game.meta.saveVersion": "Save & version",
  "game.meta.live": "Live",
  "game.meta.autoSaveOn": "Auto-save on",
  "game.meta.enabledModules": "Enabled modules",
  ...
  "game.cards.yourCardsCount": "Your cards {count}/{limit}",
  "game.cards.selected": "Selected",
  "game.cards.exchangeCards": "Exchange cards",
  "game.cards.mustTradeToContinue": "You must trade cards to continue.",
  "game.cards.tradeForReinforcements": "Trade in cards to get reinforcements.",
  "game.cards.nextExchangeBonus": "Next exchange bonus:",
  ...
  "game.players.count": "{count} players",
  "game.players.player": "Player",
  "game.players.troops": "Troops",
  "game.players.currentTurn": "Current turn",
  "game.players.you": "You",
  "game.players.commandHint": "Place troops, attack, or fortify from the command dock.",
  ...
  "game.cards.description.infantry": "Standard infantry card for reinforcement trades.",
  "game.cards.description.cavalry": "Standard cavalry card for reinforcement trades.",
  "game.cards.description.artillery": "Standard artillery card for reinforcement trades.",
  "game.cards.description.wild": "Wild card that can complete any standard reinforcement trade.",
