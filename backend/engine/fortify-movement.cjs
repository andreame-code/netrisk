...
function findOwnedPath(state, graph, ownerId, fromTerritoryId, toTerritoryId) {
...
function moveFortifyArmies(state, graph, playerId, fromTerritoryId, toTerritoryId, armiesToMove, options = {}) {
